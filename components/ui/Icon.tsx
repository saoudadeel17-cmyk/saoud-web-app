...
export type IconName =
  | 'check' | 'x' | 'alert' | 'info' | 'warning'
  | 'cart' | 'user' | 'logout' | 'settings' | 'dashboard'
  | 'package' | 'truck' | 'star' | 'star-filled' | 'search'
  | 'arrow-left' | 'arrow-right' | 'chevron-down' | 'chevron-up'
  | 'upload' | 'image' | 'eye' | 'eye-off' | 'copy'
  | 'phone' | 'mail' | 'map-pin' | 'clock' | 'calendar'
...
const paths: Record<IconName, ReactNode> = {
  ...
  warning: <><path d="m21.73 18-8-14a2 2 0 0 0-3.48 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3" /><line x1="12" y1="9" x2="12" y2="13" /><line x1="12" y1="17" x2="12.01" y2="17" /></>,
  ...
  phone: <><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 12 19.79 19.79 0 0 1 1.61 3.41 2 2 0 0 1 3.6 1.24h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L7.91 8.96a16 16 0 0 0 6.13 6.13l.96-.96a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 16.92z" /></>,
  ...
  jazzcash: <><rect x="2" y="5" width="20" height="14" rx="3" /><path d="M12 9v6M9 12h6" strokeWidth="2.5" /></>,
  bank: <><path d="m3 9 9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z" /><polyline points="9 22 9 12 15 12 15 22" /></>,
  cod: <><rect x="2" y="7" width="20" height="14" rx="2" ry="2" /><path d="M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16" /></>,
