export const products = [
    {
      ...
      detail:
        "Hand-knotted Persian silk rug inspired by Iranian palace patterns. Ideal for luxury homes, hotels, and international buyers.",
    },
    {
      id: 2,
      ...
      detail:
        "Traditional Arabian sitting mat with UAE and Qatar inspired geometric detailing.",
    },
    {
      id: 3,
      ...
      detail:
        "Pure wool rug with deep tribal motifs, made for collectors and export markets.",
    },
    {
      id: 4,
      ...
      detail:
        "Handmade traditional decor for Arabian, Persian, and luxury cultural interiors.",
    },
  ];
